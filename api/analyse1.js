...
"verdict" muss exakt "bleiben" oder "gehen" lauten. Genau eine Bio hat "empfohlen":true.`;
  ...
  const geschlecht = body.geschlecht || 'w';
  const wunschKunde = geschlecht === 'm' ? 'Wunschkunde (männlich)' : 'Wunschkundin (weiblich)';
  const genderHinweis = geschlecht === 'm'
    ? 'WICHTIG: Die Kundin/der Kunde ist männlich. Verwende durchgehend männliche Formen: "Wunschkunde", "er", "sein", "ihm", "ihn". Im Einstieg: "Lieber ' + vorname + ',".'
    : 'WICHTIG: Die Kundin ist weiblich. Verwende durchgehend weibliche Formen: "Wunschkundin", "sie", "ihr". Im Einstieg: "Liebe ' + vorname + ',".' ;

  const contentParts = [{ type: 'text', text: genderHinweis }];
